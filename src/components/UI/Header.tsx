            ...
            <Popover
              content={
                <div className="w-full h-full ">
                  <p className="popover-user hover:!bg-white hover:!text-red-400 !text-red-500 ">
                    Hello {user?.userName}
                  </p>
              ...
              arrow={false}
            >
              <Avatar size="large" className="!ml-24 !bg-red-500">
            ...
            <Popover
              content={
                <div className="w-full h-full">
                  ...
                  <p className="my-16" />
                  <a
                    className=" cursor-pointer popover-user !px-[60px] "
                    onClick={() => {
              ...
              // arrow={false}
            >
              <Avatar size="large" className="!ml-24 !bg-slate-400">
